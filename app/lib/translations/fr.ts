export const fr = {
  ...
  grid: {
    ...
    real_event:   "ÉVÉNEMENT RÉSEAU RÉEL",
  ...
  jlc: {
    ...
    why_p1: 'Le règlement actuel de la réponse à la demande est opaque : l\'utilité fait confiance à l\'auto-déclaration du client. Il n\'y a aucune preuve cryptographique que la charge a effectivement baissé. C\'est le problème des oracles appliqué à l\'énergie.',
