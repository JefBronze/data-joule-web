// HD vector fleur-de-lis (Twemoji-derived shape, recoloured to amber to match the
// "Data Joule" wordmark). Used instead of the Unicode ⚜ so rendering is consistent
// across platforms and crisp at any size.
export function FleurEmoji({ className }: { className?: string }) {
  return (
    <svg
