// Full Quebec flag (Fleurdelisé) — vector, sharp at any size.
// Blue ground with white cross and four white fleurs-de-lis.
// Used on desktop FR locale next to the Data Joule wordmark.
  ...
  return (
    ...
    >
      ...
      <g id="qc-quad">
        ...
        />
        <use xlinkHref="#qc-fleur" x="5600"/>
      </g>
      <use xlinkHref="#qc-quad" y="4000"/>
    </svg>
  )
}
