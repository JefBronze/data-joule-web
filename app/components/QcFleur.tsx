// Quebec flag fragment — blue ground + white fleur-de-lis, one quadrant of the Fleurdelisé.
export function QcFleur({ className }: { className?: string }) {
  return (
    <svg
